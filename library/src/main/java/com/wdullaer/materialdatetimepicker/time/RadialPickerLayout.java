...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = TimePickerView.HOUR_INDEX;
    private static final int MINUTE_INDEX = TimePickerView.MINUTE_INDEX;
    private static final int SECOND_INDEX = TimePickerView.SECOND_INDEX;
    private static final int AM = TimePickerView.AM;
    private static final int PM = TimePickerView.PM;
     ...
     * @param is24HourMode
     */
    public void initialize(Context context, TimePickerView timePickerView,
