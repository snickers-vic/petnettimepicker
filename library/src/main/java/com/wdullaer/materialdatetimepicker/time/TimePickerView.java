 ...
 */
public class TimePickerView extends LinearLayout implements
...
//    private Button mOkButton;
    ...
    public static TimePickerView newInstance(Context context, OnTimeSetListener callback,
                                               int hourOfDay, int minute, int second, boolean is24HourMode) {
        TimePickerView ret = new TimePickerView(context);
    ...
    public static TimePickerView newInstance(Context context, OnTimeSetListener callback,
        ...
        return TimePickerView.newInstance(context, callback, hourOfDay, minute, 0, is24HourMode);
    }
...
//        updateDisplay(false);
    ...
    public int getHour(){
        ...
        int value = mTimePicker.getHours();
        if (mIs24HourMode) {
            return value;
        } else {
    ...
    public int getMinute(){
        int value = mTimePicker.getMinutes();
    ...
    public int getSecond(){
        int value = mTimePicker.getSeconds();
